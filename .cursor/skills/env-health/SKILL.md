---
name: env-health
description: Verifies local Docker Compose dev stack health and basic repo security hygiene for the Kanban App project. Use when the user asks for an environment health check, pre-flight, dev sanity check, secure setup verification, or before deploy/feature work; also when validating that frontend, backend, and db match docs/ARCHITECTURE.md.
---
